...
public class FileDownloader {
    ...
    public FileDownloader(Context context, String add, int i) {
        this.fileUtil = new FileUtil(context, add, i);
    }
    ...
    public int downloadFile(String dirName, String fileName, String urlStr) {
        ...
        if (file.length() == 0 || file == null) {
            ...
            stringErrorMap.put("fileLength", "" + file.length());
            stringErrorMap.put("isNull", file == null ? "true" : "false");
